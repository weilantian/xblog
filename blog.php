...
if ($uid!="")
{
    ...
    if ($lv == "admin")
    {
        $text = '<div class="am-topbar-right"><div class="am-dropdown" data-am-dropdown="{boundary: \'.am-topbar\'}"><button class="am-btn am-btn-secondary am-topbar-btn am-btn-sm am-dropdown-toggle" data-am-dropdown-toggle>欢迎您，'.$username.'<span class="am-icon-caret-down"></span></button><ul class="am-dropdown-content"><li><a href="index.php?url=user">用户中心</a></li><li><a href="index.php?url=admin">博客管理</a></li><li><a href="index.php?url=login&loginout=yes">登出</a></li></ul></div></div>';
    }
    else
    {
        $text = '<div class="am-topbar-right"><div class="am-dropdown" data-am-dropdown="{boundary: \'.am-topbar\'}"><button class="am-btn am-btn-secondary am-topbar-btn am-btn-sm am-dropdown-toggle" data-am-dropdown-toggle>欢迎您，'.$username.'<span class="am-icon-caret-down"></span></button><ul class="am-dropdown-content"><li><a href="index.php?url=user">用户中心</a></li><li><a href="index.php?url=login&loginout=yes">登出</a></li></ul></div></div>';
    }
}
else
{
                            ...
                            <pre>
{
    ...
    <div class="am-u-sm-6 am-u-md-8 am-u-lg-9">
        ...
        while($row = mysql_fetch_array($result))
        {
            echo '<div class="am-panel am-panel-default"><div class="am-panel-bd"><article class="am-article"><div class="am-article-hd"><a href="index.php?url=doc&aid='.$row['aid'].'"><h1 class="am-article-title">'.$row['title'].'</h1></a><p class="am-article-meta">'.$row['artdate'].'</p></div>'.$row['content'].'</article></div></div>';
        }
        ?>
